...
export function SensorMetrics() {
  ...
  const metrics = [
    ...
    {
      label: 'bno_health',
      value: sensorData.bno_health || 0,
      displayValue: `${(sensorData.bno_health || 0).toFixed(1)}`,
      icon: <Gauge className="size-6" />,
      color: 'text-red-500',
      bgColor: 'bg-green-500/10',
    ...
    },
    {
      ...
      value: sensorData.voltage_health || 0,
      displayValue: `${(sensorData.voltage_health || 0).toFixed(1)}`,
      icon: <Gauge className="size-6" />,
      color: 'text-blue-500',
      bgColor: 'bg-green-500/10',
      sliderColor: 'bg-blue-500',
    ...
    {
      label: 'temp_health',
      value: sensorData.temp_health || 0,
      displayValue: `${(sensorData.temp_health || 0).toFixed(1)}`,
      icon: <Gauge className="size-6" />,
      color: 'text-purple-500',
      bgColor: 'bg-green-500/10',
      sliderColor: 'bg-purple-500',
    ...
    {
      label: 'lidar_health',
      value: sensorData.lidar_health || 0,
      displayValue: `${(sensorData.lidar_health || 0).toFixed(1)}`,
      icon: <Gauge className="size-6" />,
      color: 'text-yellow-500',
      bgColor: 'bg-green-500/10',
      sliderColor: 'bg-yellow-500',
